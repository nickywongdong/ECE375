...
HitRight:
		...
		ldi		waitcnt, 200	; Wait for 1 second **modified to 200 for twice the movebackwards
...
HitLeft:
		...
		ldi		mpr, MovBck	; Load Move Backward command
		out		PORTB, mpr	; Send command to port
		ldi		waitcnt, 200	; Wait for 1 second	**modifed to 200 for twice the movebackwards
		rcall	Wait			; Call wait function
...
ILoop:	dec		ilcnt			; decrement ilcnt
		...
		pop		waitcnt		; Restore wait register
		ret				; Return from subroutinestart:
